...
- [DexPaprika](https://api.dexpaprika.com) - Free DEX data API covering Optimism and 33 other chains. Pools, tokens, OHLCV, trades, real-time streaming. No API key needed.
