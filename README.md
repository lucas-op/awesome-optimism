# Awesome Optimism [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
- [Optimism Discord](https://discord.gg/optimism) - Announcements, general discussion, and support.
...
- [DexPaprika](https://api.dexpaprika.com) - DEX data API covering Optimism and 35 other chains. Pools, tokens, OHLCV, trades, SSE streaming. Free tier is 200,000 requests/month with no API key. [Docs](https://docs.dexpaprika.com)
